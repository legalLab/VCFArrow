...
#'
#' @description
#' Subset a VCFArrow object keeping only 1 SNP per locus
#'
...
#'
#' @details
#' This function subsets a VCFArrow object keeping only 1 SNP per locus,
...
#' The first SNP independent of quality is taken (may modify this in the future).
#'
#' @examples
#' vcf_filter_oneSNP(vcf_arrow = my_vcf, block_size = 10000)
#' vcf_filter_oneSNP(my_vcf, 10000)
#' vcf_filter_oneSNP(my_vcf)
#'

vcf_filter_oneSNP <- function(vcf_arrow, block_size = 10000) {
